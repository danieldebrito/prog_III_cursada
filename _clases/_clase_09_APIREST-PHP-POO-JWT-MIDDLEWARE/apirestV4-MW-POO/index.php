...
require '/clases/MWIpAddress.php';
require '/clases/MWDevice.php';
...
$app->group('/cd', function () {
  ...
  $this->get('/', \cdApi::class . ':traerTodos')->add(\MWparaCORS::class . ':HabilitarCORSTodos')->add(\MWIpAddress::class . ':getIP')->add(\MWDevice::class . ':getDevice');  //le agrego a uno solo
